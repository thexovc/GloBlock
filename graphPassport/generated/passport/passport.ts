...
export class PassportMinted extends ethereum.Event {
  get params(): PassportMinted__Params {
    return new PassportMinted__Params(this);
  }
}

export class PassportMinted__Params {
  _event: PassportMinted;

  constructor(event: PassportMinted) {
    this._event = event;
  }
